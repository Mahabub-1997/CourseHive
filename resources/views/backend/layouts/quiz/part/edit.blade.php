...
{{--                            <div class="col-md-9">--}}
{{--                                <input type="text" name="title" class="form-control" value="{{ old('title', $part->title) }}" required placeholder="Enter part title">--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                            <div class="col-md-9">--}}
{{--                                <input type="text" name="video" class="form-control" value="{{ old('video', $part->video) }}" placeholder="Enter video link (optional)">--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                            <div class="col-md-9">--}}
{{--                                <textarea name="content" class="form-control" placeholder="Enter part content">{{ old('content', $part->content) }}</textarea>--}}
{{--                            </div>--}}
{{--                        </div>--}}
