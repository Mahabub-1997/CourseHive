    ...
    <div class="content-wrapper">
                ...
                <div class="col-12">
                    <div class="info-box mb-3 d-flex justify-content-between align-items-center bg-primary text-white">
                        <div class="info-box-content">
                            <span class="info-box-text fw-bold" style="font-size: 2rem;">Add Quiz</span>
                            <span class="info-box-number" style="font-size: .7rem;">
                                Create a new quiz for your lesson
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-7 py-5 mx-auto">
            <div class="card card-primary card-outline">
                <div class="card-header text-center">{{ __('Add Quiz') }}</div>
                <div class="card-body">
                    ...
                    {{-- Create Form --}}
                    <form action="{{ route('web-quizzes.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="title" class="form-control" value="{{ old('title') }}" required placeholder="Enter quiz title">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-9 offset-md-3">
                                <input type="submit" class="btn btn-success" value="Save Quiz">
                            </div>
                        </div>
                    </form>
                </div>
