                        ...
                        <div class="card shadow-sm" style="width: 500px; height: 500px; border-radius: 15px; ">
                            @if ($course->image)
                                <img src="{{ asset('storage/' . $course->image) }}" class="card-img-top"
                                    alt="{{ $course->title }}" style="height:120px; object-fit:cover;">
                            @endif
                            <div class="card-body d-flex flex-column">
                                ...
                                @else
                                    <a href="{{ route('courses.pay', $course->id) }}"
                                        class="btn btn-primary btn-block mt-auto">Buy Now</a>
                                @endif

                                {{-- Admin Actions --}}
                                <div class="mt-2 d-flex justify-content-between">
                                    <a href="{{ route('web-online-courses.edit', $course->id) }}"
                                        class="btn btn-info btn-sm">
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                    <form action="{{ route('web-online-courses.destroy', $course->id) }}" method="POST"
